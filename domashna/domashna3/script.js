...
secondHeader1.innerHTML = `<h1>Header 1 (2)</h1>`;

const firstHeader3 = lastDiv.querySelector("h3");
firstHeader3.innerHTML = `<h3>Header 3 </h3>`;


const firstDiv = document.getElementById("first");
const fistParagraph = firstDiv.querySelector("p");
fistParagraph.innerHTML = `<p>Paragraph 1</p>`;

const secondDiv = document.querySelector(".anotherDiv");
const secondParagraph = secondDiv.querySelector("p");
secondParagraph.innerHTML = `<p>Paragraph 2</p>`;

const firstText = secondDiv.querySelector("text");
firstText.innerHTML=`<text> Text 1 </text>`;